...
<?php
	...
	{
		case "praca":
			include('Jushoom3/praca.php');
			break;
		case "oferta":
			include('Jushoom3/oferta.php');
			break;
		case "kontakt":
			include('Jushoom3/kontakt.php');
			break;
		case "topadmin":
			include('Jushoom3/topadmin.php');
			break;
		default:
			include('Jushoom3/ofirmie.php');
			break;
	}
...
?>
			<tr>
				...
				<br><br>
				&c.php; by <a href="http://securitydays.pl">SecurityDays Crew</a> 2004-2007
				</td>
			</tr>
		</table>
<br>
